...
The challenge is to create an Expenses Chart Component, part of a website designed to calculate and track expenses. Users should be able to view the bar chart, hover over individual bars to see the correct amounts for each day, see the current day's bar highlighted in a different color, view the optimal layout for the content depending on their device's screen size, and see hover states for all interactive elements on the page. A bonus challenge is to dynamically generate bars based on the data provided in a local JSON file.
